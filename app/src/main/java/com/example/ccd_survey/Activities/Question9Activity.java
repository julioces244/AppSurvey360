...
public class Question9Activity extends AppCompatActivity {
    ...
    private static final String TAG = Question9Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn9 = findViewById(R.id.btn_question9);
    ...
    public void next() {
        ...
        btn9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(8, evaluates);

                startActivity(new Intent(getApplication(), Question10Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question9Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
