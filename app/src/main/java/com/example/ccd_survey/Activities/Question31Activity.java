...
public class Question31Activity extends AppCompatActivity {
    ...
    private static final String TAG = Question31Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn31 = findViewById(R.id.btn_question31);
    ...
    public void next() {
        ...
        btn31.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(30, evaluates);

                startActivity(new Intent(getApplication(), Question32Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question31Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
