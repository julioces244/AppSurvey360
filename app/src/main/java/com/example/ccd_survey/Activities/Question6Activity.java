...
public class Question6Activity extends AppCompatActivity {
    ...
    private static final String TAG = Question6Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn6 = findViewById(R.id.btn_question6);
    ...
    public void next() {
        ...
        btn6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(5, evaluates);

                startActivity(new Intent(getApplication(), Question7Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question6Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
