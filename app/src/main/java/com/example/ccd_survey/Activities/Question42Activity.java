...
public class Question42Activity extends AppCompatActivity {

    private static final String TAG = Question42Activity.class.getSimpleName();
    ...
    public void next() {
        ...
        btn42.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(41, evaluates);

                startActivity(new Intent(getApplication(), Question43Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question42Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
