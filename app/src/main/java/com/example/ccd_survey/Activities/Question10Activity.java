...
public class Question10Activity extends AppCompatActivity {
    ...
    private static final String TAG = Question10Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn10 = findViewById(R.id.btn_question10);
    ...
    public void next() {
        ...
        btn10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(9, evaluates);

                startActivity(new Intent(getApplication(), Question11Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question10Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
