...
public class Question15Activity extends AppCompatActivity {
    ...
    private static final String TAG = Question15Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn15 = findViewById(R.id.btn_question15);
    ...
    public void next() {
        ...
        btn15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(14, evaluates);

                startActivity(new Intent(getApplication(), Question16Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question15Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
