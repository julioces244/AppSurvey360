...
public class Question51Activity extends AppCompatActivity {

    private static final String TAG = Question51Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question51);
        ...
        btn51 = findViewById(R.id.btn_question51);
    ...
    public void next() {
        ...
        btn51.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(50, evaluates);

                startActivity(new Intent(getApplication(), Question52Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question51Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
