...
public class Question4Activity extends AppCompatActivity {
    ...
    private static final String TAG = Question4Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn4 = findViewById(R.id.btn_question4);
    ...
    public void next() {
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(3, evaluates);

                startActivity(new Intent(getApplication(), Question5Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question4Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
