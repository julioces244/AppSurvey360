...
public class Question8Activity extends AppCompatActivity {
    ...
    private static final String TAG = Question8Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn8 = findViewById(R.id.btn_question8);
    ...
    public void next() {
        ...
        btn8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(7, evaluates);

                startActivity(new Intent(getApplication(), Question9Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question8Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
