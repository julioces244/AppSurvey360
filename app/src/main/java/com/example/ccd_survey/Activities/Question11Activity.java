...
public class Question11Activity extends AppCompatActivity {
    ...
    private static final String TAG = Question11Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn11 = findViewById(R.id.btn_question11);
    ...
    public void next() {
        ...
        btn11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(10, evaluates);

                startActivity(new Intent(getApplication(), Question12Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question11Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
