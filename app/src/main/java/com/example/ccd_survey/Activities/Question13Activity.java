...
public class Question13Activity extends AppCompatActivity {
    ...
    private static final String TAG = Question13Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn13 = findViewById(R.id.btn_question13);
    ...
    public void next() {
        ...
        btn13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(12, evaluates);

                startActivity(new Intent(getApplication(), Question14Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question13Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
