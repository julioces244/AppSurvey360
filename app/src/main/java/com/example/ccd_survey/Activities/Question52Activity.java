...
public class Question52Activity extends AppCompatActivity {

    private static final String TAG = Question52Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question52);
        ...
        btn52 = findViewById(R.id.btn_question52);
    ...
    public void next() {
        ...
        btn52.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(51, evaluates);

                startActivity(new Intent(getApplication(), Question53Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question52Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
