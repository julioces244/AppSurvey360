...
public class Question54Activity extends AppCompatActivity {

    private static final String TAG = Question54Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question54);
        ...
        btn54 = findViewById(R.id.btn_question54);
    ...
    public void next() {
        ...
        btn54.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(53, evaluates);

                startActivity(new Intent(getApplication(), Question55Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question54Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
