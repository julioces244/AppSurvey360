...
public class Question7Activity extends AppCompatActivity {
    ...
    private static final String TAG = Question7Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn7 = findViewById(R.id.btn_question7);
    ...
    public void next() {
        ...
        btn7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(6, evaluates);

                startActivity(new Intent(getApplication(), Question8Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question7Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
