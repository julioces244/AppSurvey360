...
public class Question12Activity extends AppCompatActivity {
    ...
    private static final String TAG = Question12Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn12 = findViewById(R.id.btn_question12);
    ...
    public void next() {
        ...
        btn12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(11, evaluates);

                startActivity(new Intent(getApplication(), Question13Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question12Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
