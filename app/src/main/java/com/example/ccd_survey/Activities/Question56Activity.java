...
public class Question56Activity extends AppCompatActivity {

    private static final String TAG = Question56Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question56);
        ...
        btn56 = findViewById(R.id.btn_question56);
    ...
    public void next() {
        ...
        btn56.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(55, evaluates);

                startActivity(new Intent(getApplication(), Question57Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question56Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
