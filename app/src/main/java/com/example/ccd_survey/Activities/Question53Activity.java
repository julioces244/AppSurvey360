...
public class Question53Activity extends AppCompatActivity {

    private static final String TAG = Question53Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question53);
        ...
        btn53 = findViewById(R.id.btn_question53);
    ...
    public void next() {
        ...
        btn53.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(52, evaluates);

                startActivity(new Intent(getApplication(), Question54Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question53Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
