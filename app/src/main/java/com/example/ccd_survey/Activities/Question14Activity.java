...
public class Question14Activity extends AppCompatActivity {
    ...
    private static final String TAG = Question14Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn14 = findViewById(R.id.btn_question14);
    ...
    public void next() {
        ...
        btn14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(13, evaluates);

                startActivity(new Intent(getApplication(), Question15Activity.class));
            ...
            public void onResponse(Call<List<Evaluated>> call, Response<List<Evaluated>> response) {
                try {
                    ...
                    try {
                        ...
                        Toast.makeText(Question14Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }catch (Throwable x){}
                }
            }
