...
public class Question58Activity extends AppCompatActivity {

    private static final String TAG = Question58Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question58);
        ...
        btn58 = findViewById(R.id.btn_question58);
    ...
    public void next() {
        ...
        btn58.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                examenRepository.addEvaluatedsPorPregunta(57, evaluates);
                    ...
                    public void onResponse(Call<ResponseMessage> call, Response<ResponseMessage> response) {
                        try {
                            ...
                            if (response.isSuccessful()) {
                                ...
                                Toast.makeText(Question58Activity.this, responseMessage.getMessage(), Toast.LENGTH_LONG).show();
                            ...
                            try {
                                ...
                                Toast.makeText(Question58Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                            } catch (Throwable x) {
                            }
                        }
                    }
