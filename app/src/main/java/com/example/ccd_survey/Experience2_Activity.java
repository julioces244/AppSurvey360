...
public class Experience2_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_experience2_);
        ...
        Button btn_experience = findViewById(R.id.btn_experience2);
        btn_experience.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), Experience3_Activity.class);
    ...
    private void  spinner1(){
        ...
        Spinner spinner = findViewById(R.id.spn_experience_q7);
    ...
    private void  spinner2(){
        ...
        Spinner spinner = findViewById(R.id.spn_experience_q8);
        ArrayAdapter adapter = ArrayAdapter.createFromResource(this,
                R.array.answers, R.layout.spinner_item);
    ...
    private void  spinner3(){
        ...
        Spinner spinner = findViewById(R.id.spn_experience_q9);
        ArrayAdapter adapter = ArrayAdapter.createFromResource(this,
                R.array.answers, R.layout.spinner_item);
    ...
    private void  spinner4(){
        ...
        Spinner spinner = findViewById(R.id.spn_experience_q10);
        ArrayAdapter adapter = ArrayAdapter.createFromResource(this,
                R.array.answers, R.layout.spinner_item);
    ...
    private void spinner5(){
        ...
        Spinner spinner = findViewById(R.id.spn_experience_q11);
        ArrayAdapter adapter = ArrayAdapter.createFromResource(this,
                R.array.answers, R.layout.spinner_item);
